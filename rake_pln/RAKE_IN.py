...
class RakeKeywordExtractor:
  ...
  def __init__(self):
    self.stopwords = set(nltk.corpus.stopwords.words())  # stopwords.words('portuguese')
...
def test():
  ...
  start sentences. It must be trained on a large collection of plaintext in the target 
  language before it can be used. Whats your name?. How to get.
'''
